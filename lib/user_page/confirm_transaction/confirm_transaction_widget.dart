...
class ConfirmTransactionWidget extends StatefulWidget {
  const ConfirmTransactionWidget({Key? key}) : super(key: key);
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'dc3pnf4z' /* Be wary of falling victim to s... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '211nb520' /* Please check the destination a... */,
                                            ),
                                            textAlign: TextAlign.start,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                ...
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        context.pushNamed('ENSuccessRequest');
                                      },
                                      child: Container(
                                        height: 50.0,
                                        decoration: BoxDecoration(
