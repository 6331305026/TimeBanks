...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFD5B31);
  late Color secondary = const Color(0xFFFFAA24);
  late Color tertiary = const Color(0xFFFFE0AE);
  ...
  late Color error = const Color(0xFFFD5B31);
